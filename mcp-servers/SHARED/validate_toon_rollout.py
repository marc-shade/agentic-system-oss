...
MCP_SERVERS = {
    "agi-mcp": str(_STORAGE_BASE / "mcp-servers" / "agi-mcp" / "server.py"),
    "video-transcript-mcp": str(_STORAGE_BASE / "mcp-servers" / "video-transcript-mcp" / "server.py"),
    "research-paper-mcp": str(_STORAGE_BASE / "mcp-servers" / "research-paper-mcp" / "server.py"),
    "nuclei-mcp": str(_STORAGE_BASE / "mcp-servers" / "nuclei-mcp" / "main.py")
}
