...
echo ""
echo "  # Quick test (10 tasks)"
echo "  python3 gaia_official_benchmark.py --level 1 --limit 10"
echo ""
echo "  # Full Level 1 benchmark (53 tasks)"
echo "  python3 gaia_official_benchmark.py --level 1"
echo ""
echo "  # Level 2 benchmark (86 tasks)"
echo "  python3 gaia_official_benchmark.py --level 2"
echo ""
echo "  # Level 3 benchmark (27 tasks)"
echo "  python3 gaia_official_benchmark.py --level 3"
echo "=============================================="
