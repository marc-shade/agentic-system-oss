...
class HookDeploymentManager:
    ...
    def test_python_imports(self):
        ...
        critical_modules = [
            '/home/marc/.claude/principle_0_orchestrator_hook.py',
            '/home/marc/.claude/enhanced_delegation_enforcement.py',
            '/home/marc/.claude/siobhan_voice.py'
        ]
    ...
    def generate_deployment_report(self, test_results: Dict[str, Any]) -> Dict[str, Any]:
        ...
        report = {
            ...
            'next_steps': [
                ...
                "Check logs for any issues: /home/marc/.claude/logs/",
                "Run manual validation: python3 /home/marc/.claude/hooks/test_all_hooks_integration.py"
            ]
        }
