...
HOOKS_CONFIG_PATH = "/home/marc/.claude/hooks/master_hooks_config.json"
LOG_DIR = "/home/marc/.claude/logs"
    ...
    config["hooks"]["SessionStart"] = [
        {
            ...
            "hooks": [
                {
                    "type": "command",
                    "command": "python3 /home/marc/.claude/hooks/session-start/situational_awareness_hook.py",
                    "timeout": 5000,
                    "background": False,
...
def verify_hook_installation():
    ...
    try:
        ...
        result = subprocess.run([
            "python3", "/home/marc/.claude/hooks/session-start/situational_awareness_hook.py"
...
def create_integration_summary():
    ...
    summary = {
        "situational_awareness_hook": {
            "status": "deployed",
            "file": "/home/marc/.claude/hooks/session-start/situational_awareness_hook.py",
            "configuration": "updated in master_hooks_config.json",
            "claude_integration": "added to SessionStart hooks",
            "cache_file": "/home/marc/.claude/.situational_cache.json",
            "log_file": "/home/marc/.claude/logs/situational_awareness.log",
            "features": [
    ...
    summary_file = "/home/marc/.claude/hooks/situational_awareness_deployment.json"
...
def main():
    ...
    try:
        ...
        print("Check logs at: /home/marc/.claude/logs/situational_awareness.log")
