...
Generates complete hook configurations for /home/marc/.claude/settings.json
        ...
        "PreToolUse": [
            {
                ...
                "hooks": [
                    {
                        "type": "command",
                        "command": "python3 /home/marc/.claude/hooks/security/delegation_enforcer_hook.py",
            ...
            },
            {
                ...
                "hooks": [
                    {
                        "type": "command", 
                        "command": "python3 /home/marc/.claude/hooks/security/privacy_scanner_hook.py",
            ...
            },
            {
                ...
                "hooks": [
                    {
                        "type": "command",
                        "command": "python3 /home/marc/.claude/hooks/security/resource_monitor_hook.py",
            ...
            },
            {
                ...
                "hooks": [
                    {
                        "type": "command",
                        "command": "python3 /home/marc/.claude/hooks/security/agent_capability_validator_hook.py",
        ...
        "PostToolUse": [
            {
                ...
                "hooks": [
                    {
                        "type": "command",
                        "command": "python3 /home/marc/.claude/hooks/quality/code_quality_check.py",
        ...
        "UserPromptSubmit": [
            {
                ...
                "hooks": [
                    {
                        "type": "command",
                        "command": "python3 /home/marc/.claude/hooks/security/critical_operation_alert.py",
        ...
        "Notification": [
            {
                ...
                "hooks": [
                    {
                        "type": "command",
                        "command": "python3 /home/marc/.claude/hooks/ux/voice_notification.py",
...
def validate_hook_files():
    ...
    hook_files = [
        '/home/marc/.claude/hooks/security/delegation_enforcer_hook.py',
        '/home/marc/.claude/hooks/security/privacy_scanner_hook.py',
        '/home/marc/.claude/hooks/security/resource_monitor_hook.py',
        '/home/marc/.claude/hooks/security/agent_capability_validator_hook.py'
    ]
