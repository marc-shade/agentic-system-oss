    ...
    try:
        ...
        if youtube_url:
            ...
            if not cleaned_prompt or len(cleaned_prompt) < 10:
                ...
                transcript_dir = "/Users/marc/Documents/Cline/MCP/youtube-transcript-mcp"
...
/Users/marc/Documents/Cline/MCP/youtube-transcript-mcp/extract_transcript.py "{youtube_url}"
