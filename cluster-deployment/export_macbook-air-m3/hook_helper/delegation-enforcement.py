...
class DelegationEnforcer:
    ...
    def __init__(self, config_path: str = "/Users/marc/.claude/delegation-config.json"):
    ...
    def check_bypass_mechanisms(self, tool_input: str, environment: Dict[str, str]) -> bool:
        ...
        if maintenance_config.get("enabled", False):
            marker_file = maintenance_config.get("file_marker", "/Users/marc/.claude/maintenance-mode.flag")
    ...
    def _write_log(self, entry: Dict[str, Any]):
        ...
        log_file = self.config.get("logging", {}).get("file", "/Users/marc/.claude/delegation-enforcement.log")
...
def main():
    ...
    try:
        ...
        try:
            with open('/Users/marc/.claude/delegation-enforcement-errors.log', 'a') as f:
