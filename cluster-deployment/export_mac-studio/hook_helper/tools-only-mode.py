...
# Configuration
TOOLS_ONLY_MODE_FILE = os.path.expanduser("~/.claude/.tools_only_mode")
STATS_FILE = os.path.expanduser("~/.claude/.tools_only_stats.json")
...
- Context tokens saved: ~{context_saved:,}
...
Context saved: ~{stats.get('context_saved', 0):,} tokens
