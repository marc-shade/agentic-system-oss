...
class MemoryAwareGreetings:
    ...
    def __init__(self):
        self.memory_db = Path("/Users/marc/.claude/agentic-evolution/events.db")
        self.session_db = Path("/Users/marc/.claude/session_memory.db")
        self.log_file = Path("/Users/marc/.claude/memory_greetings.log")
