...
def test_hooks_integration():
    ...
    # Load settings
    settings_file = '/Users/marc/.claude/settings.json'
    ...
    test_hooks = [
        '/Users/marc/.claude/hooks/tool_name_validator.py',
        '/Users/marc/.claude/hooks/startup_sequence.py',
    ...
    with open('/Users/marc/.claude/hooks/.integration_test_results.json', 'w') as f:
