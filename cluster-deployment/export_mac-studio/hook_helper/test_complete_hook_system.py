...
def main():
    ...
    test_results.append(run_test(
        ...
        "python3 /Users/marc/.claude/hooks/startup_sequence.py",
    ...
    test_results.append(run_test(
        "Voice Usage Checker",
        "python3 /Users/marc/.claude/hooks/voice_usage_checker.py",
    ...
    test_results.append(run_test(
        ...
        'python3 /Users/marc/.claude/hooks/enforce_delegation.py Write \'{"file_path": "/tmp/test.txt", "content": "test"}\'',
    ...
    test_results.append(run_test(
        ...
        'python3 /Users/marc/.claude/hooks/enforce_delegation.py Read \'{"file_path": "/tmp/test.txt"}\'',
    ...
    test_results.append(run_test(
        ...
        "python3 -c \"import sys; sys.path.append('/Users/marc/.claude'); from enhanced_delegation_hooks import setup_enhanced_delegation_system; result = setup_enhanced_delegation_system(); print('SUCCESS' if result.get('test_results', {}).get('system_functional', False) else 'FAILED')\"",
    ...
    test_results.append(run_test(
        ...
        "python3 -c \"import sys; sys.path.append('/Users/marc/.claude'); from voice_usage_enforcer import voice_startup_check; result = voice_startup_check(enable_greeting=False); print('SUCCESS' if result else 'FAILED')\"",
        lambda r, o: "SUCCESS" in o
    ))
    ...
    test_results.append(run_test(
        ...
        "python3 -c \"import sys; sys.path.append('/Users/marc/.claude'); from principle_0_orchestrator_hook import p0_stats; stats = p0_stats(); print('SUCCESS' if stats.get('score', 0) >= 90 else 'FAILED')\"",
        lambda r, o: "SUCCESS" in o
    ))
    ...
    test_results.append(run_test(
        ...
        "python3 -c \"import sys; sys.path.append('/Users/marc/.claude'); from privacy_detection_hook import check_privacy_requirement; result = check_privacy_requirement('Process employee SSN data'); print('SUCCESS' if result else 'FAILED')\"",
        lambda r, o: "SUCCESS" in o
    ))
    ...
    test_results.append(run_test(
        ...
        "python3 -c \"import sys; sys.path.append('/Users/marc/.claude'); from start_autonomous_dgm import dgm_startup_check; result = dgm_startup_check(); print('SUCCESS' if result else 'FAILED')\"",
        lambda r, o: "SUCCESS" in o
    ))
    ...
    test_results.append(run_test(
        "Health Monitor",
        "python3 /Users/marc/.claude/health-monitor-simple.py 2>/dev/null | grep -c 'HEALTHY'",
    ...
    report_file = "/Users/marc/.claude/hook_system_test_report.json"
    try:
